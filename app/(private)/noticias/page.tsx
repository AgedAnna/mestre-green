...
const NEWS: NewsArticle[] = [
  ...
  },
  {
    ...
    category: "Futebol Internacional",
    title:
      "Qual o grupo mais forte da Copa do Mundo? Veja lista com base no ranking da Fifa",
    href: "/noticias/2",
  },
  {
    id: "3",
    ...
    title:
      "Flamengo confirma contratação e apresenta novo reforço para a temporada",
    href: "/noticias/3",
  },
  {
    id: "4",
    ...
    title:
      "Real Madrid vence nos pênaltis e avança às semifinais da Champions League",
    href: "/noticias/4",
  },
  {
    id: "5",
    category: "Futebol Internacional",
    title:
      "Messi marca dois e lidera Argentina em amistoso preparatório para a Copa",
    href: "/noticias/5",
  },
];
      ...
      <ul className="divide-y divide-gray-100">
        {NEWS.map((article) => (
          ...
          >
            <Link
              href={article.href}
              className="w-full h-52 md:shrink-0 md:w-64 md:h-44 rounded-xl bg-gray-200 hover:opacity-90 transition-opacity"
            />
